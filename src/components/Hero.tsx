...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ 
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-white/100 dark:from-black/100 via-white/30 dark:via-black/20 to-background dark:to-background" style={{ zIndex: 1 }} />
